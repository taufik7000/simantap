...
<style>
    ...
    .gradient-text {
        /* Menggunakan warna primary-400 ke primary-600 */
    ...
    .grid-pattern {
        /* Menggunakan warna primary-500 dengan opacity */
        background-image: 
...
@section('content')
<section class="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-slate-50 via-primary-50 to-primary-100">
    <div class="absolute inset-0 grid-pattern opacity-30"></div>
    <div class="absolute top-20 left-10 w-72 h-72 bg-gradient-to-r from-primary-300/20 to-primary-400/20 rounded-full blur-3xl"></div>
    <div class="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-primary-400/20 to-primary-500/20 rounded-full blur-3xl"></div>
    <div class="absolute top-1/2 left-1/2 w-64 h-64 bg-gradient-to-r from-primary-300/20 to-primary-400/20 rounded-full blur-3xl"></div>
    
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="text-center lg:text-left">
                <div class="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-primary-600/10 to-primary-700/10 border border-primary-200/50 backdrop-blur-sm mb-8">
                ...
                <h1 class="text-5xl lg:text-7xl font-bold mb-8 leading-tight">
                    ...
                    <br>
                    <span class="gradient-text">Simalungun Administrasi</span>
                    <br>
                    <span class="text-gray-700">Digital Terbaru</span>
                </h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4 mb-12">
                    <a href="{{ route('register') }}" class="group relative px-8 py-4 bg-gradient-to-r from-primary-600 to-primary-700 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 overflow-hidden">
            ...
            <div class="relative">
                <div class="floating-card glassmorphism rounded-3xl p-8 shadow-2xl border border-white/20">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div class="bg-gradient-to-r from-primary-50 to-primary-100 rounded-2xl p-4 border border-primary-200/50">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-primary-600 text-sm font-medium">Dokumen Selesai</p>
                                    <p class="text-2xl font-bold text-primary-700">83,247</p>
                                </div>
                ...
                <div class="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-r from-primary-300 to-primary-400 rounded-2xl opacity-80 floating-card" style="animation-delay: -2s;"></div>
                <div class="absolute -bottom-6 -left-6 w-16 h-16 bg-gradient-to-r from-primary-400 to-primary-500 rounded-2xl opacity-80 floating-card" style="animation-delay: -4s;"></div>
            </div>
        </div>
    </div>
</section>
...
<section class="py-24 bg-white scroll-reveal">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-20">
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-primary-50 to-primary-100 border border-primary-100 mb-6">
                <span class="text-sm font-medium text-primary-600">✨ Fitur Unggulan</span>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="group relative">
                <div class="h-full bg-gradient-to-br from-white to-gray-50 rounded-3xl p-8 border border-gray-100 hover:border-primary-200 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
                    <div class="relative mb-8">
                        <div class="w-16 h-16 bg-gradient-to-r from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div class="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r from-primary-400 to-teal-400 rounded-full opacity-70 group-hover:scale-125 transition-transform duration-300"></div>
                    </div>
                    
                    <h3 class="text-2xl font-bold text-gray-900 mb-4 group-hover:text-primary-600 transition-colors duration-300">
                        {{ $feature['title'] ?? 'Fitur' }}
                    </h3>
...
<section class="py-24 bg-gradient-to-br from-slate-900 via-primary-900 to-primary-800 relative overflow-hidden scroll-reveal">
    <div class="absolute inset-0">
        <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-primary-600/20 to-primary-700/20"></div>
        <div class="absolute top-20 left-20 w-64 h-64 bg-gradient-to-r from-primary-400/20 to-teal-400/20 rounded-full blur-3xl"></div>
        <div class="absolute bottom-20 right-20 w-80 h-80 bg-gradient-to-r from-primary-500/20 to-green-400/20 rounded-full blur-3xl"></div>
    </div>
    
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl lg:text-5xl font-bold text-white mb-6">
                Dipercaya Ribuan <span class="text-primary-300">Warga</span>
            </h2>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="text-center group">
                <div class="glassmorphism rounded-3xl p-8 hover:bg-white/20 transition-all duration-300 hover:-translate-y-2">
                    <div class="w-12 h-12 bg-gradient-to-r from-primary-400 to-primary-500 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                        @if($index === 0)
...
<section class="py-24 bg-gray-50 scroll-reveal">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-20">
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-primary-50 to-teal-50 border border-primary-100 mb-6">
                <span class="text-sm font-medium text-primary-600">💬 Testimoni Pengguna</span>
            </div>
            <h2 class="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="group bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
                <div class="w-12 h-12 bg-primary-100 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary-200 transition-colors duration-300">
...
<section class="py-24 bg-gradient-to-r from-primary-600 via-primary-700 to-primary-800 relative overflow-hidden scroll-reveal">
    ...
    <div class="relative z-10 max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <h2 class="text-4xl lg:text-6xl font-bold text-white mb-8 leading-tight">
            Siap Memulai<br>
            <span class="text-primary-200">Transformasi Digital</span>?
        </h2>
        
        <p class="text-xl lg:text-2xl text-primary-100 mb-12 max-w-3xl mx-auto leading-relaxed">
        ...
        <div class="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <a href="{{ route('register') }}" class="group relative px-10 py-5 bg-white text-primary-600 font-bold rounded-2xl shadow-2xl hover:shadow-3xl transform hover:-translate-y-2 transition-all duration-300 overflow-hidden">
        ...
        <div class="flex flex-wrap justify-center items-center gap-12 text-white/80">
            <div class="flex items-center">
                <div class="w-8 h-8 bg-primary-400 rounded-full flex items-center justify-center mr-3">
