        ...
        <div class="flex items-center justify-between h-16 sm:h-20">
            ...
            <div class="hidden lg:flex items-center space-x-6">
                ...
                <div class="flex items-center space-x-6">
                    <a href="/" class="relative font-medium text-gray-700 hover:text-emerald-600 transition-colors duration-200 py-2 group">
                        Home
                    ...
                    <a href="{{ route('layanan.semua') }}" class="relative font-medium text-gray-700 hover:text-emerald-600 transition-colors duration-200 py-2 group">
                        Semua Layanan
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-emerald-500 to-emerald-600 group-hover:w-full transition-all duration-300"></span>
                    </a>
                    {{-- Lacak Permohonan sekarang menjadi bagian dari menu utama --}}
                    <a href="{{ route('lacak.permohonan') }}" class="relative font-medium text-gray-700 hover:text-emerald-600 transition-colors duration-200 py-2 group">
                        Lacak Permohonan
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-emerald-500 to-emerald-600 group-hover:w-full transition-all duration-300"></span>
                    </a>
                    <a href="{{ route('kb.index') }}" class="relative font-medium text-gray-700 hover:text-emerald-600 transition-colors duration-200 py-2 group">
                        Pusat Bantuan
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-emerald-500 to-emerald-600 group-hover:w-full transition-all duration-300"></span>
                    </a>
                </div>
