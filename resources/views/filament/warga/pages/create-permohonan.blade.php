<x-filament-panels::page>
    <div
        x-data="{
            ...
            requirements: '',
            selectedFormulirId: null,
            selectedFormulirNama: null,
            
            selectService(service) {
                this.selectedService = service.nama;
                this.requirements = service.deskripsi;
                this.selectedFormulirId = service.formulir_master_id;
                this.selectedFormulirNama = service.nama_formulir;
        ...
        <form wire:submit="create">
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
                ...
                <div class="lg:col-span-3 space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 p-6">
                            @foreach($this->jenisPermohonanData as $service)
                                <div 
                                    ...
                                    :class="{ 'border-primary-600 bg-primary-50 dark:bg-primary-900/20 ring-2 ring-primary-600': selectedService === '{{ $service['nama'] }}', 'border-gray-300 dark:border-gray-600 hover:border-primary-500': selectedService !== '{{ $service['nama'] }}' }"
                    ...
                    <div x-show="selectedFormulirId" x-transition>
                        <x-filament::section class="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
                             <x-slot name="heading" class="px-6 py-4 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div class="p-6">
                                ...
                                <a x-bind:href="`/download-formulir-master/${selectedFormulirId}`"
                                ...
                                >
                                    ...
                                    <span x-text="selectedFormulirNama ? `Unduh: ${selectedFormulirNama}` : 'Unduh Formulir Wajib'"></span>
                                </a>
                            </div>
                        </x-filament::section>
                    </div>
            ...
            <div x-show="selectedService" x-transition class="mt-8 pt-8 border-t border-gray-200 dark:border-white/10 flex justify-end">
