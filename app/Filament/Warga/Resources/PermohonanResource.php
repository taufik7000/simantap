                    ...
                    ->schema([
                        ...
                        Forms\Components\Placeholder::make('deskripsi_jenis_permohonan')
                            ...
                            ->content(function (Get $get): HtmlString {
                                ...
                                // Menambahkan div dengan class 'prose' untuk styling
                                $styledDescription = '<div class="prose max-w-full dark:prose-invert">' . $description . '</div>';

                                return new HtmlString($styledDescription);
                            }),
                    ]),
